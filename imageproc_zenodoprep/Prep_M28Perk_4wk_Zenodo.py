...
last_csv = '/Volumes/Image_Data/Mor28iCreiGFP_PerkcKO_Experiments/Analysis_Glomeruli_WTvsCtrl/Blinded_Annotations/4wk_Blinded_Annotations/LookupTable_1-12-22_Output.tsv'
regex = '^MAX.*4wk.*(WT|Ctrl|Exp).*20x.*.tif$'
file_copy_dir = '/Volumes/Backup_HJS/Papers/UPR_AxonGuidance_2021/Zenodo/Images_20xGlomeruli/4wk_M28_Perk'
...
f_list = [os.path.join(subdir, f) for subdir in subdirs for f in os.listdir(subdir) if re.match(regex, f) is not None]
