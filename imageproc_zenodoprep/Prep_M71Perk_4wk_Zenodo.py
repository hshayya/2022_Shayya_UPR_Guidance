...
#User Inputs
dir_ = '/Volumes/Image_Data/M71iCreiGFP_PerkcKO_Experiments' #some of these old
last_csv = '/Volumes/Image_Data/M71iCreiGFP_PerkcKO_Experiments/Analysis_Glomeruli_WTvsCtrl/Blinded_Annotation/4wk_Blinded_Annotation/LookupTable_output.tsv'
regex = '^MAX.*4wk.*(WT|Ctrl|Exp).*20x.*.tif$'
file_copy_dir = '/Volumes/Backup_HJS/Papers/UPR_AxonGuidance_2021/Zenodo/Images_20xGlomeruli/4wk_M71_Perk'
...
glom_order = ['LLateral','LMedial','RLateral','RMedial']
