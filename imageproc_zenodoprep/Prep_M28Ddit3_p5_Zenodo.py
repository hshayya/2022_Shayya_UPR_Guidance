...
#User Inputs
dir_ = '/Volumes/Image_Data/M28iCreiGFP_Ddit3cKO_Experiments' #some of these old
last_csv = '/Volumes/Image_Data/M28iCreiGFP_Ddit3cKO_Experiments/Analysis_Glomeruli/Blinded_Assignment/LookupTable_2-14-22_Output.tsv'
regex = '^MAX.*(WT|Ctrl|Exp).*20x.*.tif$'
file_copy_dir = '/Volumes/Backup_HJS/Papers/UPR_AxonGuidance_2021/Zenodo/Images_20xGlomeruli/p5_M28_Ddit3'
