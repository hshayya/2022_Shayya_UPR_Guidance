...
#Create Salmon Index, - Fluors
salmon --no-version-check index -t IS_merged_CodingTranscriptsHS_transcripts.fasta -i IS_merged_CodingTranscriptsHS_mm10_k31

#Create Combined fasta w/ fluors
